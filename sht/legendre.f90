...
subroutine legendre_init(y,jx,kx,N,siny,cosy,sinydy,epm,faca,facb)
   ...
   double precision, dimension(1:N*kx/2-1), intent(out) :: epm
   double precision, dimension(0:N*kx/2-1,0:N*kx/2-1), intent(out) :: faca,facb
...
subroutine forward(N,qqg,yg,jxg,kx,fqqg)
  ...
  double complex, dimension(0:jxg-1,0:kx-1), intent(in) :: qqg
  double complex, dimension(0:N*kx/2-1,0:kx-1), intent(out) :: fqqg
...
subroutine backward(N,qq,yg,jxg,kx,fqqg)
   ...
   double complex, dimension(0:jxg-1,0:kx-1), intent(out) :: fqqg
